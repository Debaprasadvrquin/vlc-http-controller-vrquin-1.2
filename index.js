<!DOCTYPE html>
<html lang="en" style="background-color: rgb(209, 209, 209);">
...
<body class="prevent-select" style="background-color: rgb(255, 255, 255);overflow: hidden; ">
    <!-- <div class="vrc0"> -->
    <!-- <div class="media"> -->
    <!-- <div class="head-btn"> -->
    ...
    <!-- </div> -->
    <!-- <div class="contents"> View Angles </div> -->

    <div class="top-nav">
        <img src="/images/vrquin-641.png" alt="" class="client-logo">
        <img src="/images/vrquin-64.png" alt="" class="my-logo">

        <div class="loadiframe">
            <h3>Available Colours</h3>
            <button id="black_button1" class="box black" data-src="BeoPlayH6fromDimensivaXR.46.html"></button>
            <button id="yellow_button1" class="box brown" data-src="BeoPlayH6fromDimensiva.43.html"></button>
            <button id="white_button1" class="box silver" data-src="BeoPlayH6fromDimensivaXR.45.html"></button>
        </div>
        <!-- <div class="next_div"><a href="/vrquin4" style="text-decoration:none" class="pri">
                <div id="button4" class="next"><i class='fa fa-chevron-left'></i></div>
            </a>
            <a href="/vrquin2" style="text-decoration:none" class="nex">
                <div id="button2" class="next"><i class='fa fa-chevron-right'></i></div>
            </a>
        </div> -->
    </div>
    ...
    <div class="aside">
        ...
        <div class="col-sm-6">
            <div class="item-desc-1">
                <div class="item-year-1">
                    <h3>About this item</h3>
                    <p>
                    <ul>
                        <li>Tap into instant wireless connectivity with the latest Bluetooth V5.0. Yes, Rockerz 550
                            on-ear headphones have IPX5 dust and water resistance making it perfect for sports and
                            adventures.</li>
                        <li>Its 50mm dynamic drivers help pump out immersive audio all day long, Charging Time 2.5
                            hours, Frequency Response - 20Hz-20KHz</li>
                        <li>The mighty 500mAh battery capacity offers a superior playback time of up to 20 Hours
                        </li>
                        <li> It has been ergonomically designed and structured as an over-ear headphone to provide the
                            best user experience</li>
                ...
                <div class="next_div">
                    <a href="/vrquin4" style="text-decoration:none" class="pri">
                        <div id="button4" class="next"><i class='fa fa-chevron-left'></i></div>
                    </a>
                    <a href="/vrquin2" style="text-decoration:none; " class="nex">
                        <div id="button2" class="next"><i class='fa fa-chevron-right'></i></div>
                ...
                <div class="prd-info">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="prd-head">
                                <div class="type"><span>Size</span></div>
                                <div class="ms">
                                    <div class="column">
                                        <div class="width">
                                            <h4>Width</h4>
                            ...
                            <div class="prd-location">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="type"><span>Availble Locations</span></div>
                                    </div>
                                </div>
                                <ul class="locations">
                                    <div>
                                        <li class="col-xs-4">Bhubaneswar</li>
                                        <li class="col-xs-4">kolkata</li>
                                        <li class="col-xs-4">Bangalore</li>
                                    </div>
                                    <div>
                                        <li class="col-xs-4">Singapore</li>
                                        <li class="col-xs-4">Los Angeles</li>
                                    </div>

                                </ul>
                                <div class="scroll" style="margin-top:-20px; margin-left: 140px;">
                                    <button onclick="openForm()">View more</button>
                                </div>
                            </div>
    ...
    <div id="popupForm" class="popupForm">
        <div id="closeForm" class="closeForm" onclick="closeForm()">X</div>
        <img src="/images/vrquin.png" alt="scan" class="scan">
    </div>
    <!-- <div class="footer">
        <p style="padding-top:0px;">© 2022,<a class="text-dark" href="https://vrquin.com" style="color: #fff !important;">
            VRQUIN</a></p>
    </div> -->
    <!-- <div class="c-content" style="overflow: hidden;" onclick="closeForm()">
        <div class="c-body" style="overflow: hidden;">
            <iframe id="frame" src="holotube3.72.html" allowfullscreen style=" " frameborder="0" scrolling="no">
            </iframe>
        </div>
    </div> -->
    <div class="c-content" style="overflow: hidden;" onclick="closeForm()">
        <div class="c-body" style="overflow: hidden;">
            <iframe id="frame" src="BeoPlayH6fromDimensivaXR.45.html" allowfullscreen frameborder="0" scrolling="no">
            </iframe>
        </div>
    </div>
    ...
    <script>function iframeChange() {
        ...
        window.onload = iframeChange;</script>
    <script>
        function openForm() {
    ...
    <script>
        ...
        d3.json("/library1", {
            ...
            for (let file of files) {
                ...
                m.append('button').text(file.title).on("click", function () {
                    callVLC("load", { fileid: file.id })
                })
            }
        })
        ...
        const black_button1 = d3.select("#black_button1");
        black_button1.on("click", function () {
            callVLC("black_button1", {})
        })

        const yellow_button1 = d3.select("#yellow_button1");
        yellow_button1.on("click", function () {
            callVLC("yellow_button1", {})
        })

        const white_button1 = d3.select("#white_button1");
        white_button1.on("click", function () {
            callVLC("white_button1", {})
        })
        ...
        const button3 = d3.select("#button3");
        button3.on("click", function () {
            callVLC("button3", {})
        })
        const button4 = d3.select("#button4");
